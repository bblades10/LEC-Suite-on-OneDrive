...
<script runat="server">
    ...
    {
        rd.Load(Server.MapPath("certexpirereport.rpt"));
        rd.SetDatabaseLogon("MOCIC_IT", "!it_MOCIC!", "srv-dbs1", "FieldCoorSuite");
        rd.SetParameterValue("@District", Request.QueryString["r"]);
        rd.SetParameterValue("@State", Request.QueryString["s"]);
...
<body>
    ...
    <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" 
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="certexpirereport.rpt">
            </Report>
