...
<% Response.ContentType = "application/vnd.ms-excel"; 
   Response.AddHeader ("Content-Disposition", "attachment; filename=participationbystate.xls"); %>
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["st"] != "00")
        {
            strResult += " for State " + Request.QueryString["st"] + " (Does not include Node or Third-Party Submissions)</b></td></tr>";
        }
        else
        {
        ...
        SqlCommand myCmd = new SqlCommand("spSelectParticipationByStateReport", myConn);
